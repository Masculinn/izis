...
export const Team = () => {
  return (
    <section className="max-w-7xl mx-auto relative md:min-h-screen h-auto md:px-0 px-8 md:mt-24 mt-8">
      ...
      <div className="flex md:flex-row flex-col gap-4 h-96  w-full">
        <MotionChain
